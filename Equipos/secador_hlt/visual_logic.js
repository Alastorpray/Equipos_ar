 ...
 * Fri Nov 13 2020 16:05:33 GMT-0500 (hora estándar de Perú)
...
this.procedures["restart-animation"] = restart_animation;
this.procedures["show warning"] = show_warning;
this.procedures["pro1-paso1"] = pro1_paso1;
this.procedures["pro1-paso3"] = pro1_paso3;
this.procedures["pro1-paso2"] = pro1_paso2;
this.procedures["pro1-paso4"] = pro1_paso4;
this.procedures["pro1-paso6"] = pro1_paso6;
this.procedures["pro1-paso7"] = pro1_paso7;
this.procedures["pro1-paso5"] = pro1_paso5;

var PROC = {
    "restart-animation": restart_animation,
    "show warning": show_warning,
    "pro1-paso1": pro1_paso1,
    "pro1-paso3": pro1_paso3,
    "pro1-paso2": pro1_paso2,
    "pro1-paso4": pro1_paso4,
    "pro1-paso6": pro1_paso6,
    "pro1-paso7": pro1_paso7,
    "pro1-paso5": pro1_paso5,
};

var id, AR_available, estado_proceso, animation_counter;
...
function setObjDirection(objNames, x, y, z, lockUp) {
    ...
    for (var i = 0; i < objNames.length; i++) {
        ...
        if (lockUp) {
            ...
            var sign = _pGlob.vec3Tmp.crossVectors(trackDir, projDir).dot(lockDir) > 0 ? 1 : -1;

            obj.setRotationFromAxisAngle(plane.normal, sign * trackDir.angleTo(projDir));

            if (obj.parent) {
                obj.parent.matrixWorld.decompose(_pGlob.vec3Tmp, _pGlob.quatTmp, _pGlob.vec3Tmp);
...
function restart_animation() {
  changeVis('llave_mixta_1', false);
  changeVis('llave_mixta_2', false);
  changeVis('alineador_laser_bot', false);
  changeVis('alineador_laser_top', false);
}
...
function pro1_paso1() {
  if (animation_counter == 0) {
    changeVis('llave_mixta_2', true);
    outline('llave_mixta_2', 'ENABLE');
    registerSetTimeout(2, function() {
      outline('llave_mixta_2', 'DISABLE');

      operateAnimation('PLAY', 'llave_mixta_2', 1, 190, 'LoopOnce', 1,
              function() {
        registerSetTimeout(1, function() {
          changeVis('llave_mixta_2', false);

          operateAnimation('PLAY', getAnimations(['GROUP', 'pernos_guarda_a']), 1, 220, 'LoopOnce', 1,
                  function() {
            registerSetTimeout(1, function() {
              changeVis(['GROUP', 'pernos_guarda_a'], false);

              operateAnimation('PLAY', 'guarda_a', 1, 120, 'LoopOnce', 1,
                      function() {
                registerSetTimeout(1, function() {
                  changeVis('guarda_a', false);

                  operateAnimation('PLAY', 'guarda_b', 1, 60, 'LoopOnce', 1,
                          function() {
                    changeVis('guarda_b', false);
                    animation_counter = 1;
...
function pro1_paso3() {
  if (animation_counter == 2) {
    ...
    operateAnimation('PLAY', 'faja_7_arm', 1, 180, 'LoopOnce', 1,
            function() {
      registerSetTimeout(1, function() {
        changeVis('faja.006', false);

        operateAnimation('PLAY', 'faja_6_arm', 1, 180, 'LoopOnce', 1,
                function() {
          registerSetTimeout(1, function() {
            changeVis('faja.005', false);

            operateAnimation('PLAY', 'faja_5_arm', 1, 360, 'LoopOnce', 1,
                    function() {
              registerSetTimeout(1, function() {
                changeVis('faja.004', false);

                operateAnimation('PLAY', 'faja_4_arm', 1, 300, 'LoopOnce', 1,
                        function() {
                  registerSetTimeout(1, function() {
                    changeVis('faja.003', false);

                    operateAnimation('PLAY', 'faja_3_arm', 1, 420, 'LoopOnce', 1,
                            function() {
                      registerSetTimeout(1, function() {
                        changeVis('faja.002', false);

                        operateAnimation('PLAY', 'faja_2_arm', 1, 420, 'LoopOnce', 1,
                                function() {
                          registerSetTimeout(1, function() {
                            changeVis('faja.001', false);

                            operateAnimation('PLAY', 'faja_1_arm', 1, 540, 'LoopOnce', 1,
                                    function() {
                              registerSetTimeout(1, function() {
                                changeVis('faja', false);
                                animation_counter = 3;
                                console.log(animation_counter);
                                pro1_paso4();
                              });
...
function pro1_paso2() {
  if (animation_counter == 1) {
    changeVis('llave_mixta_1', true);
    outline('llave_mixta_1', 'ENABLE');
    registerSetTimeout(2, function() {
      outline('llave_mixta_1', 'DISABLE');

      operateAnimation('PLAY', 'llave_mixta_1', 1, 160, 'LoopOnce', 1,
              function() {
        registerSetTimeout(1, function() {

          operateAnimation('PLAY', getAnimations(['GROUP', 'pernos_tornillos']), 1, 60, 'LoopOnce', 1,
                  function() {
            registerSetTimeout(1, function() {

              operateAnimation('PLAY', 'llave_mixta_1', 170, 330, 'LoopOnce', 1,
                      function() {
                changeVis('llave_mixta_1', false);
                registerSetTimeout(1, function() {

                  operateAnimation('PLAY', getAnimations(['GROUP', 'pernos_tornillos']), 60, 120, 'LoopOnce', 1,
                          function() {}, undefined, false);


                  operateAnimation('PLAY', 'motor', 60, 120, 'LoopOnce', 1,
                          function() {
                    animation_counter = 2;
                    console.log(animation_counter);
                    pro1_paso3();
...
function pro1_paso4() {
  if (animation_counter == 3) {
    changeVis('alineador_laser_top', true);
    changeVis('alineador_laser_bot', true);
    outline('alineador_laser_top', 'ENABLE');
    registerSetTimeout(2, function() {
      outline('alineador_laser_top', 'DISABLE');
      outline('alineador_laser_bot', 'DISABLE');

      operateAnimation('PLAY', 'alineador_laser_top', 1, 160, 'LoopOnce', 1,
              function() {
        outline('alineador_laser_bot', 'ENABLE');
        registerSetTimeout(2, function() {
          outline('alineador_laser_bot', 'DISABLE');

          operateAnimation('PLAY', 'alineador_laser_bot', 1, 160, 'LoopOnce', 1,
                  function() {
...
function pro1_paso7() {
  if (animation_counter == 6) {
    changeVis('guarda_b', true);

    operateAnimation('PLAY', 'guarda_b', 1, 60, 'LoopOnce', 1,
            function() {
      registerSetTimeout(1, function() {
        changeVis('guarda_a', true);

        operateAnimation('PLAY', 'guarda_a', 1, 120, 'LoopOnce', 1,
                function() {
          registerSetTimeout(1, function() {
            changeVis(['GROUP', 'pernos_guarda_a'], true);
...
function pro1_paso5() {
  if (animation_counter == 4) {
    ...
    registerSetTimeout(1, function() {
      ...
      operateAnimation('PLAY', 'faja_1_arm', 1, 540, 'LoopOnce', 1,
              function() {
        changeVis('faja.001', true);
        registerSetTimeout(1, function() {

          operateAnimation('PLAY', 'faja_2_arm', 1, 420, 'LoopOnce', 1,
                  function() {
            changeVis('faja.002', true);
            registerSetTimeout(1, function() {

              operateAnimation('PLAY', 'faja_3_arm', 1, 420, 'LoopOnce', 1,
                      function() {
                changeVis('faja.003', true);
                registerSetTimeout(1, function() {

                  operateAnimation('PLAY', 'faja_4_arm', 1, 300, 'LoopOnce', 1,
                          function() {
                    changeVis('faja.004', true);
                    registerSetTimeout(1, function() {

                      operateAnimation('PLAY', 'faja_5_arm', 1, 360, 'LoopOnce', 1,
                              function() {
                        changeVis('faja.005', true);
                        registerSetTimeout(1, function() {

                          operateAnimation('PLAY', 'faja_6_arm', 1, 180, 'LoopOnce', 1,
                                  function() {
                            changeVis('faja.006', true);
                            registerSetTimeout(1, function() {
...
registerOnClick('indicator_invis_plane', function() {
  changeVis('base', true);
  changeVis(['GROUP', 'cambio_fajas'], true);
  changeVis(['GROUP', 'pernos_tornillos'], true);
  changeVis(['GROUP', 'Herramientas'], true);
  changeVis(['GROUP', 'pernos_guarda_a'], true);
  changeVis(['GROUP', 'fajas'], true);
  restart_animation();
  changeVis(['GROUP', 'indicator_group'], false);
  changeVis('indicator_invis_plane', false);
  setObjTransform('base', 'position', arHitPoint('x'), arHitPoint('y'), -4, false);
  // Look atsade!
  setObjDirection('base', getObjTransform('Camera', 'position', 'x'), getObjTransform('Camera', 'position', 'y'), getObjTransform('Camera', 'position', 'z'), true);
...
eventHTMLElem('click', 'button-ar', true, function(event) {});

restart_animation();
if (AR_available) {
  enterARMode('ORIGIN', function() {
    changeVis(['GROUP', 'secador_hlt'], false);
    changeVis(['GROUP', 'pernos_tornillos'], false);
    changeVis(['GROUP', 'Herramientas'], false);
    changeVis(['GROUP', 'pernos_guarda_a'], false);
    changeVis(['GROUP', 'Environment'], false);
    changeVis(['GROUP', 'fajas'], false);
    changeVis(['GROUP', 'difusor'], false);
    changeVis(['GROUP', 'lonchera'], false);
    changeVis(['GROUP', 'pernos_del_difusor'], false);
    changeVis(['GROUP', 'cambio_fajas'], false);
    changeVis(['GROUP', 'difusor_inservibles'], false);
    changeVis(['GROUP', 'herramientas_saacke'], false);
...
estado_proceso = 0;
animation_counter = 0;
eventHTMLElem('click', 'e003_p001', true, function(event) {
  restart_animation();
  estado_proceso = 1;
  console.log('proceso 1');
});
eventHTMLElem('click', 'button-play', true, function(event) {
  if (estado_proceso == 0) {
    console.log('No hacer nada');
  } else if (estado_proceso == 1) {
    if (animation_counter == 0) {
